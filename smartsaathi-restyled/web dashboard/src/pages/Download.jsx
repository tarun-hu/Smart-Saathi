  ...
  return (
    <div>
      ...
      <div style={{background:'#fff',padding:'60px 48px 48px',borderBottom:'.5px solid rgba(0,0,0,.08)',textAlign:'center'}}>
        ...
        <h1 style={{fontSize:40,fontWeight:800,letterSpacing:'-.04em',color:'#1d1d1f',marginBottom:10,lineHeight:1.06}}>Get the SmartSaathi app</h1>
      ...
      <div style={{padding:'52px 48px',background:'#f5f5f7'}}>
        ...
        <div style={{maxWidth:900,margin:'0 auto'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr auto',gap:40,alignItems:'center',background:'#fff',borderRadius:22,padding:36,marginBottom:14,boxShadow:'0 2px 8px rgba(0,0,0,.04),0 12px 28px rgba(0,0,0,.06)'}}>
            <div>
              ...
              <p style={{fontSize:15,color:'#6e6e73',lineHeight:1.6,marginBottom:14}}>If your caregiver has already set up your account, tap "Log In". Enter the access code they provided — you'll be taken directly to your personalised home screen.</p>
              {['Your caregiver generates your access code from their dashboard','Enter the code in the app — it looks like CS-4827-X','You\'ll see your greeting, health stats, and the big TAP TO TALK button'].map(t=>(
          ...
          <div style={{display:'grid',gridTemplateColumns:'auto 1fr',gap:40,alignItems:'center',background:'#f5f5f7',borderRadius:22,padding:36,marginBottom:14,boxShadow:'0 2px 8px rgba(0,0,0,.04),0 12px 28px rgba(0,0,0,.06)'}}>
            ...
            <div>
              ...
              <p style={{fontSize:15,color:'#6e6e73',lineHeight:1.6,marginBottom:14}}>First time? Tap "Sign Up", enter your name and phone number, and create a password. Your caregiver receives a pairing request — once they approve, you're connected and ready to go.</p>
              {['Enter your name, phone, and a secure password','Your caregiver receives a pairing request to approve','Once approved, you\'re securely connected — setup complete'].map(t=>(
                <div key={t} style={{display:'flex',alignItems:'flex-start',gap:9,fontSize:13,color:'#6e6e73',marginBottom:6}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr auto',gap:40,alignItems:'center',background:'#fff',borderRadius:22,padding:36,marginBottom:14,boxShadow:'0 2px 8px rgba(0,0,0,.04),0 12px 28px rgba(0,0,0,.06)'}}>
            <div>
              ...
              <p style={{fontSize:15,color:'#6e6e73',lineHeight:1.6,marginBottom:14}}>You'll see your home screen with a big TAP TO TALK microphone button. Just tap it and speak naturally — SmartSaathi understands and handles the rest.</p>
              {['Tap the big microphone button and speak naturally','Use tiles: My Day, Medicines, Brain Game, Family','Press SOS anytime — your caregiver is alerted instantly'].map(t=>(
                <div key={t} style={{display:'flex',alignItems:'flex-start',gap:9,fontSize:13,color:'#6e6e73',marginBottom:6}}>
        ...
        <div style={{textAlign:'center',padding:'24px 0 6px'}}>
          <p style={{fontSize:13,color:'#aeaeb2'}}>Are you a caregiver? <button onClick={()=>navigate('/signup')} style={{background:'none',border:'none',color:'#1975d2',fontSize:13,fontWeight:700,cursor:'pointer'}}>Sign up here →</button></p>
        </div>
      </div>
