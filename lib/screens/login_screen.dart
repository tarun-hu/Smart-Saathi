...
class _LoginScreenState extends ConsumerState<LoginScreen> with SingleTickerProviderStateMixin {
  ...
  String? _selectedRole; // null = role selection, 'senior' or 'caregiver'
    ...
    try {
      ...
      if (didAuthenticate && mounted) {
        ...
        if (client.auth.currentUser == null) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(content: Text('No active session. Please login with email first.')),
          );
          return;
        }
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: _selectedRole == 'caregiver'
                ...
                : [const Color(0xFF003049), const Color(0xFF0A5C8A), const Color(0xFF1976D2)],
          ),
        ),
        child: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              ...
              style: TextStyle(fontSize: 16, color: Colors.white.withAlpha(180), letterSpacing: 0.5),
            ),
            const SizedBox(height: 60),

            Text(
              "I am a...",
              style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: Colors.white.withAlpha(220)),
            ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: gradientColors.last.withAlpha(80), blurRadius: 20, offset: const Offset(0, 8)),
          ],
        ),
        child: Row(
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(subtitle, style: TextStyle(fontSize: 14, color: Colors.white.withAlpha(200))),
                ],
              ),
            ),
            Icon(Icons.arrow_forward_ios, color: Colors.white.withAlpha(180), size: 20),
          ],
        ),
      ),
    );
  ...
  // ─── STEP 2: AUTH FORM (LOGIN / SIGNUP) ──────────────────────
  Widget _buildAuthForm() {
    final isSenior = _selectedRole == 'senior';
    final roleColor = isSenior ? const Color(0xFFFF5722) : const Color(0xFF1565C0);
        ...
        child: Column(
          ...
          children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(roleLabel, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 14)),
                    ],
                  ),
                ),
              ],
            ...
            Text(
              ...
              style: TextStyle(fontSize: 15, color: Colors.white.withAlpha(180)),
            ),
                      ...
                      child: Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            color: !_isSignUp ? const Color(0xFF003049) : Colors.white.withAlpha(160),
                          ),
                        ),
                      ),
                    ),
            ...
            SizedBox(
              ...
              child: _isLoading
                  ...
                  : ElevatedButton(
                      ...
                      child: Text(
                        _isSignUp ? "Create $roleLabel Account" : "Login as $roleLabel",
              ...
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("or", style: TextStyle(color: Colors.white.withAlpha(140), fontSize: 14)),
                  ),
                  Expanded(child: Divider(color: Colors.white.withAlpha(40))),
                ],
              ),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        "Use Fingerprint",
                        style: TextStyle(color: Colors.white.withAlpha(220), fontWeight: FontWeight.w600, fontSize: 16),
                      ),
                    ],
                  ),
                ),
